export default {
  ...
  contacts: [
    ...
    { text: 'Skype', href: 'callto:skype:live:.cid.f00786ab772de349' },
  ],
  skills: [
    { title: 'HTML', link: `https://html.spec.whatwg.org` },
    { title: 'CSS', link: `https://www.w3.org/Style/CSS/` },
    { title: 'SCSS/SASS', link: `https://sass-lang.com/` },
    { title: 'Java Script', link: `https://en.wikipedia.org/wiki/JavaScript` },
    { title: 'Vue v.2 & 3', link: `https://v3.vuejs.org` },
    { title: 'Composition Api', link: `https://v3.vuejs.org/api/composition-api.html#setup` },
    { title: 'VueX', link: `https://next.vuex.vuejs.org` },
    { title: 'Router', link: `https://next.router.vuejs.org` },
    { title: 'NPM', link: `https://www.npmjs.com` },
    { title: 'Git Hub', link: `https://github.com` },
    { title: 'FireBase', link: `https://firebase.google.com` },
    { title: 'Google Web Analytics', link: `https://analytics.google.com/analytics` },
    { title: 'Photoshop', link: `https://www.adobe.com/products/photoshop.html` },
  ],
  education: [
    {
      title: 'Dnipro National Mining University',
      text: ' The department of Mine aerology and <br />a labor safety, 2016',
      subText: 'Graduated and worked as a Labor Inspector'
    }
  ],
  languages: [
    'English – Elementary',
